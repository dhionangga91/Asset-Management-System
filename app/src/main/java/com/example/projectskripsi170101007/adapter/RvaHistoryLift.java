...
public class RvaHistoryLift extends RecyclerView.Adapter<RvaHistoryLift.ViewHolder> {

    //Deklarasi Variable
    private ArrayList<ModelHistoricalPmLift> listHistory;
    private Context context;


    //Membuat Konstruktor, untuk menerima input dari Database
    public RvaHistoryLift(ArrayList<ModelHistoricalPmLift> listHistory, Context context) {
    ...
    @Override
    public RvaHistoryLift.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(RvaHistoryLift.ViewHolder holder, final int position) {
        ...
        ModelHistoricalPmLift currentHistory = listHistory.get(position);
