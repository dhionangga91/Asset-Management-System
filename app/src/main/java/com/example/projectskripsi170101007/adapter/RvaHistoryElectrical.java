...
public class RvaHistoryElectrical extends RecyclerView.Adapter<RvaHistoryElectrical.ViewHolder> {

    //Deklarasi Variable
    private ArrayList<ModelHistoricalElectrical> listHistory;
    private Context context;

    //Membuat Konstruktor, untuk menerima input dari Database
    public RvaHistoryElectrical(ArrayList<ModelHistoricalElectrical> listHistory, Context context) {
    ...
    @Override
    public RvaHistoryElectrical.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(RvaHistoryElectrical.ViewHolder holder, final int position) {
        ...
        ModelHistoricalElectrical currentHistory = listHistory.get(position);
