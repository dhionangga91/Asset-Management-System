...
public class RvaHistoryHvac extends RecyclerView.Adapter<RvaHistoryHvac.ViewHolder> {

    //Deklarasi Variable
    private ArrayList<ModelHistoricalHvac> listHistory;
    private Context context;


    //Membuat Konstruktor, untuk menerima input dari Database
    public RvaHistoryHvac(ArrayList<ModelHistoricalHvac> listHistory, Context context) {
    ...
    @Override
    public RvaHistoryHvac.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(RvaHistoryHvac.ViewHolder holder, final int position) {
        ...
        ModelHistoricalHvac currentHistory = listHistory.get(position);
