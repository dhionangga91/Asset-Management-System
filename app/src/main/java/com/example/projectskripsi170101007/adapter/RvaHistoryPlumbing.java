...
public class RvaHistoryPlumbing extends RecyclerView.Adapter<RvaHistoryPlumbing.ViewHolder> {

    //Deklarasi Variable
    private ArrayList<ModelHistoricalPmPlumbing> listHistory;
    private Context context;


    //Membuat Konstruktor, untuk menerima input dari Database
    public RvaHistoryPlumbing(ArrayList<ModelHistoricalPmPlumbing> listHistory, Context context) {
    ...
    @Override
    public RvaHistoryPlumbing.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(RvaHistoryPlumbing.ViewHolder holder, final int position) {
        ...
        ModelHistoricalPmPlumbing currentHistory = listHistory.get(position);
