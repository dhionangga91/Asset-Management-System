...
import com.example.projectskripsi170101007.adapter.RecyclerViewAdapter4;
...
public class MyListWoHvac extends AppCompatActivity implements RecyclerViewAdapter4.dataListener {
    //Deklarasi Variable untuk RecyclerView
    private RecyclerView recyclerView;
    private RecyclerView.Adapter adapter;
    private FirebaseRecyclerOptions<ModelWoHvac> options;
    ...
    private ArrayList<ModelWoHvac> dataWoHvac;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_list_wo_hvac);
        ...
        Home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MyListWoHvac.this, MainActivity.class);
        ...
        getSupportActionBar().setTitle("WorkOrder Hvac");
    ...
    private void cekKoneksi() {
        ...
        if(networkInfo != null && networkInfo.isConnected()){
            ...
            options = new FirebaseRecyclerOptions.Builder<ModelWoHvac>()
                    //   Referensi Database yang akan digunakan beserta data Modelnya
                    .setQuery(mDatabase.child("Aset").child("Workorder").child("hvac"), ModelWoHvac.class)
    ...
    private void GetDataReject() {
        ...
        auth = FirebaseAuth.getInstance();
        mDatabase.child("Aset").child("Workorder").child("hvac").orderByChild("status").equalTo("Reject")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        dataWoHvac = new ArrayList<>();

                        for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                            //Mapping data pada DataSnapshot ke dalam objek hvac
                            ModelWoHvac modelWoHvac = snapshot.getValue(ModelWoHvac.class);

                            //Mengambil Primary Key, digunakan untuk proses Update dan Delete
                            modelWoHvac.setKey(snapshot.getKey());
                            dataWoHvac.add(modelWoHvac);
                            ImageURL.setText(modelWoHvac.getPicture());
                        }

                        //Inisialisasi Adapter dan data Wo dalam bentuk Array
                        adapter = new RecyclerViewAdapter4(dataWoHvac, MyListWoHvac.this);
    ...
    private void GetDataApproved() {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference();
        auth = FirebaseAuth.getInstance();
        mDatabase.child("Aset").child("Workorder").child("hvac").orderByChild("status").equalTo("Approved")
                .addValueEventListener(new ValueEventListener() {
    ...
    private void GetDataFinish() {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference();
        auth = FirebaseAuth.getInstance();
        mDatabase.child("Aset").child("Workorder").child("hvac").orderByChild("status").equalTo("Finish")
                .addValueEventListener(new ValueEventListener() {
    ...
    private void GetDataWaitfor() {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference();
        auth = FirebaseAuth.getInstance();
        mDatabase.child("Aset").child("Workorder").child("hvac").orderByChild("status").equalTo("In Queue")
                .addValueEventListener(new ValueEventListener() {
    ...
    private void GetDataOnProgress() {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference();
        auth = FirebaseAuth.getInstance();
        mDatabase.child("Aset").child("Workorder").child("hvac").orderByChild("status").equalTo("On Progress")
                .addValueEventListener(new ValueEventListener() {
...
//                .orderByChild("status").equalTo("On Progress")
    ...
    @Override
    public void onDeleteData(ModelWoHvac data, int position) {
        /*
            ...
            mDatabase.child("Aset")
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            Toast.makeText(MyListWoHvac.this, "Succesfully deleted", Toast.LENGTH_SHORT).show();
                        }
                    });
        }else {
            Toast.makeText(MyListWoHvac.this, "Insufficient Access Level", Toast.LENGTH_SHORT).show();
        }
    }
