...
public class Update2WoHvac extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update2_wo_hvac);

        mStorage= FirebaseStorage.getInstance().getReference("Aset");
        mDatabase = FirebaseDatabase.getInstance().getReference("Aset/Workorder/hvac");
        ...
        Submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if( isEmpty(cekRemarks) ) {
                    Toast.makeText(Update2WoHvac.this, "Please Fill All Fields", Toast.LENGTH_SHORT).show();
                } else if (StatusCek.getText().toString().equals("In Queue")){
                    Toast.makeText(Update2WoHvac.this, "This Workorder is not started yet", Toast.LENGTH_SHORT).show();
                }
                else if (StatusCek.getText().toString().equals("Finish")){
                    Toast.makeText(Update2WoHvac.this, "This Workorder has already finish", Toast.LENGTH_SHORT).show();
                }
                else if (StatusCek.getText().toString().equals("Approved")){
                    Toast.makeText(Update2WoHvac.this, "This Workorder has already approved", Toast.LENGTH_SHORT).show();
                }
                else if (StatusCek.getText().toString().equals("Reject")){
                    Toast.makeText(Update2WoHvac.this, "This Workorder has already rejected", Toast.LENGTH_SHORT).show();
                }
                    ...
                    */
                    ...
                    ModelWoHvac setHvac = new ModelWoHvac();
                    setHvac.setWocode(Wocode.getText().toString());
                    setHvac.setName(Name.getText().toString());
                    setHvac.setLocation(Location.getText().toString());
                    setHvac.setPic(Pic.getText().toString());
                    setHvac.setMaintenanceDate(MaintenanceDate.getText().toString());
                    setHvac.setRemarks(Remarks.getText().toString());
                    setHvac.setStatus(Status.getText().toString());
                    setHvac.setUserInput(UserInput.getText().toString());
                    setHvac.setWoDate(WoDate.getText().toString());
                    setHvac.setUserStart(UserStart.getText().toString());
                    setHvac.setStartDate(StartDate.getText().toString());
                    setHvac.setUserFinish(UserFinish.getText().toString());
                    setHvac.setFinishDate(FinishDate.getText().toString());
                    setHvac.setUserApproved(UserApproved.getText().toString());
                    setHvac.setApprovedDate(ApprovedDate.getText().toString());
                    setHvac.setUserReject(UserReject.getText().toString());
                    setHvac.setRejectDate(RejectDate.getText().toString());
                    updateWoHvac(setHvac);
                    uploadImage();
                }
            }
        });
                ...
                if(task.isSuccessful()){
                    ...
                    mStorage.child(pathImage).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            mDatabase = FirebaseDatabase.getInstance().getReference();
                            mDatabase.child("Aset").child("Workorder").child("hvac").child(getKey).child("picture").setValue(downloadURL);
                        }
                    });
                }
            }
    ...
    private void updateWoHvac(ModelWoHvac setHvac) {
        ...
        mDatabase.child("Aset")
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(Update2WoHvac.this, "Successfull Updated", Toast.LENGTH_SHORT).show();
                        showNotification();
                        finish();
                    }
                });
    ...
    private void getData() {
        mDatabase.child("Aset").child("Workorder").child("hvac");
