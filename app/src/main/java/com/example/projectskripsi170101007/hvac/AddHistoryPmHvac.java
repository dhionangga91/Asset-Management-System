...
public class AddHistoryPmHvac extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_history_pm_hvac);
        ...
        Submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ( isEmpty(getRemarks) || isEmpty(getPic) || isEmpty(getMaintenanceDate) ) {
                    ...
                    Toast.makeText(AddHistoryPmHvac.this, "Incomplete Data", Toast.LENGTH_SHORT).show();
                } else {
                    cekKoneksi();
    ...
    private void cekStatus() {
        if (Status.getText().toString().equals("Approved")){
            ...
            Toast.makeText(AddHistoryPmHvac.this,"Workorder not approved yet",Toast.LENGTH_SHORT).show();
        }
    }

    private void uploadData() {
        if( (CurrentUser.getText().toString().equals(AuthAdmin))  && mDatabase != null) {
            mDatabase.child("Aset").child("History").child("Hvac").child(Name.getText().toString()).push().setValue(new ModelHistoricalHvac(
                    Pic.getText().toString(),
                    MaintenanceDate.getText().toString(),
                    Remarks.getText().toString()

            ));
            Toast.makeText(AddHistoryPmHvac.this, "Uploading Success", Toast.LENGTH_SHORT).show();
            Intent i = new Intent(AddHistoryPmHvac.this, MyListHvac.class);
            startActivity(i);
        } else {
            Toast.makeText(AddHistoryPmHvac.this, "Insufficient Access Level", Toast.LENGTH_SHORT).show();
            finish();
        }
    }
