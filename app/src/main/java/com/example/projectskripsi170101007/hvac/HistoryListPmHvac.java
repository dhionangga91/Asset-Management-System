...
import com.example.projectskripsi170101007.adapter.RvaHistoryHvac;
import com.example.projectskripsi170101007.model.ModelHistoricalHvac;
...
public class HistoryListPmHvac extends AppCompatActivity {
    ...
    private FirebaseRecyclerOptions<ModelHistoricalHvac> options;

    //Deklarasi Variable Database Reference dan ArrayList dengan Parameter Class Model kita.
    private DatabaseReference mDatabase;
    private ArrayList<ModelHistoricalHvac> dataHistory;
    ...
    List<ModelHistoricalHvac> historylist;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_history_list_pm_hvac);
    ...
    private void cekKoneksi() {
        ...
        if(networkInfo != null && networkInfo.isConnected()){
            ...
            options = new FirebaseRecyclerOptions.Builder<ModelHistoricalHvac>()
                    // Referensi Database yang akan digunakan beserta data Modelnya
                    .setQuery(mDatabase.child("Aset").child("History").child("Hvac"), ModelHistoricalHvac.class)
    ...
    private void GetData(){
        ...
        mDatabase.child("Aset").child("History").child("Hvac").child(Name.getText().toString())
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                            ...
                            ModelHistoricalHvac historicalPM = snapshot.getValue(ModelHistoricalHvac.class);
                        ...
                        adapter = new RvaHistoryHvac(dataHistory, HistoryListPmHvac.this);
    ...
    private void fetchPaymentUsers() {
        mDatabase = FirebaseDatabase.getInstance().getReference().child("Aset").child("History").child("Hvac").child(Name.getText().toString());
...
//creating an object and setting to displlay
                    ModelHistoricalHvac pays = new ModelHistoricalHvac();
    ...
    private void createHistoryReport(List<ModelHistoricalHvac> historylist) throws DocumentException, FileNotFoundException{
        ...
        for (int i = 0; i < historylist.size(); i++) {
            ModelHistoricalHvac pay = historylist.get(i);
