...
public class Update4WoElectrical extends AppCompatActivity {

    private TextView CurrentUser, Wocode, Name, Pic, MaintenanceDate, Location, Status, UserInput, WoDate, UserStart, StartDate,CodeNotif;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update4_wo_electrical);
        ...
        RejectDate.setText(getDateToday());
        ...
        Submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if( isEmpty(cekRemarks) ) {
                    Toast.makeText(Update4WoElectrical.this, "Please Fill All Fields", Toast.LENGTH_SHORT).show();
                }
                else if (StatusCek.getText().toString().equals("In Queue")){
                    Toast.makeText(Update4WoElectrical.this, "This Workorder is not over yet", Toast.LENGTH_SHORT).show();
                }
                else if (StatusCek.getText().toString().equals("On Progress")){
                    Toast.makeText(Update4WoElectrical.this, "This Workorder is not over yet", Toast.LENGTH_SHORT).show();
                }
                else if (StatusCek.getText().toString().equals("Approved")){
                    Toast.makeText(Update4WoElectrical.this, "This Workorder already approved", Toast.LENGTH_SHORT).show();
                }
                else if (StatusCek.getText().toString().equals("Reject")){
                    Toast.makeText(Update4WoElectrical.this, "This Workorder has already rejected", Toast.LENGTH_SHORT).show();
                }
    ...
    private void cekAdmin() {
        if ((CurrentUser.getText().toString().equals(AuthAdmin))){
            ...
            Toast.makeText(Update4WoElectrical.this, "Insufficient Access Level", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void getDataUser() {
        ...
        mDatabase.child("User").child(GetUserID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange( DataSnapshot snapshot) {
                ...
                UserReject.setText(admin.getUsername());
    ...
    private void uploadImage() {
        ...
        Container.setImageResource(R.drawable.reject);
        ...
        mDatabase.child("Aset")
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(Update4WoElectrical.this, "Successfull Updated", Toast.LENGTH_SHORT).show();
                        showNotification();
                        finish();
                    }
                });
    ...
    private void showNotification() {
        ...
        try {
            ...
            notificationObj.put("body","Has been Rejected");
