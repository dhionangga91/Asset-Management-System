...
public class Update2WoElectrical extends AppCompatActivity {

    private TextView Wocode, Name, Pic, MaintenanceDate, Location, Status, UserInput, WoDate, UserStart, StartDate,CodeNotif;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update2_wo_electrical);

        mStorage= FirebaseStorage.getInstance().getReference("Aset");
        mDatabase = FirebaseDatabase.getInstance().getReference("Aset/Workorder/electrical");
        Wocode = findViewById(R.id.wocode);
        CodeNotif = findViewById(R.id.codenotif);
        ...
        FinishDate.setText(getDateToday());
        ...
        Submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if( isEmpty(cekRemarks) ) {
                    Toast.makeText(Update2WoElectrical.this, "Please Fill All Fields", Toast.LENGTH_SHORT).show();
                } else if (StatusCek.getText().toString().equals("In Queue")){
                    Toast.makeText(Update2WoElectrical.this, "This Workorder is not started yet", Toast.LENGTH_SHORT).show();
                }
                else if (StatusCek.getText().toString().equals("Finish")){
                    Toast.makeText(Update2WoElectrical.this, "This Workorder has already finish", Toast.LENGTH_SHORT).show();
                }
                else if (StatusCek.getText().toString().equals("Approved")){
                    Toast.makeText(Update2WoElectrical.this, "This Workorder has already approved", Toast.LENGTH_SHORT).show();
                }
                else if (StatusCek.getText().toString().equals("Reject")){
                    Toast.makeText(Update2WoElectrical.this, "This Workorder has already rejected", Toast.LENGTH_SHORT).show();
                }
                    ...
                    */
                    ...
                    ModelWoElectrical setElectrical = new ModelWoElectrical();
                    setElectrical.setWocode(Wocode.getText().toString());
                    setElectrical.setName(Name.getText().toString());
                    setElectrical.setLocation(Location.getText().toString());
                    setElectrical.setPic(Pic.getText().toString());
                    setElectrical.setMaintenanceDate(MaintenanceDate.getText().toString());
                    setElectrical.setRemarks(Remarks.getText().toString());
                    setElectrical.setStatus(Status.getText().toString());
                    setElectrical.setUserInput(UserInput.getText().toString());
                    setElectrical.setWoDate(WoDate.getText().toString());
                    setElectrical.setUserStart(UserStart.getText().toString());
                    setElectrical.setStartDate(StartDate.getText().toString());
                    setElectrical.setUserFinish(UserFinish.getText().toString());
                    setElectrical.setFinishDate(FinishDate.getText().toString());
                    setElectrical.setUserApproved(UserApproved.getText().toString());
                    setElectrical.setApprovedDate(ApprovedDate.getText().toString());
                    setElectrical.setUserReject(UserReject.getText().toString());
                    setElectrical.setRejectDate(RejectDate.getText().toString());
                    updateWoElectrical(setElectrical);
                    uploadImage();
                }
            }
        });
    ...
    private void getDataUser() {
        ...
        mDatabase.child("User").child(GetUserID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange( DataSnapshot snapshot) {
                ...
                UserFinish.setText(admin.getUsername());
            }
    ...
    private void uploadImage() {
        ...
        Container.setImageResource(R.drawable.onprogress);
                ...
                if(task.isSuccessful()){
                    ...
                    mStorage.child(pathImage).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            mDatabase = FirebaseDatabase.getInstance().getReference();
                            mDatabase.child("Aset").child("Workorder").child("electrical").child(getKey).child("picture").setValue(downloadURL);
                        }
                    });
                }
            }
    ...
    private void updateWoElectrical(ModelWoElectrical setElectrical) {
        ...
        mDatabase.child("Aset")
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(Update2WoElectrical.this, "Successfull Updated", Toast.LENGTH_SHORT).show();
                        showNotification();
                        finish();
                    }
                });
    ...
    private void showNotification() {
        ...
        try {
            ...
            notificationObj.put("title","Workorder "+ CodeNotif.getText().toString());
            notificationObj.put("body","Has been completed");
