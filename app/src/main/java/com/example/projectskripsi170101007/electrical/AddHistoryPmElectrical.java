...
public class AddHistoryPmElectrical extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_history_electrical);
        ...
        Submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ( isEmpty(getRemarks) || isEmpty(getPic) || isEmpty(getMaintenanceDate) ) {
                    ...
                    Toast.makeText(AddHistoryPmElectrical.this, "Incomplete Data", Toast.LENGTH_SHORT).show();
                } else {
                    cekKoneksi();
    ...
    private void cekStatus() {
        if (Status.getText().toString().equals("Approved")){
            ...
            Toast.makeText(AddHistoryPmElectrical.this,"Workorder not approved yet",Toast.LENGTH_SHORT).show();
        }
    }

    private void uploadData() {
        if( (CurrentUser.getText().toString().equals(AuthAdmin))  && mDatabase != null) {
            mDatabase.child("Aset").child("History").child("Electrical").child(Name.getText().toString()).push().setValue(new ModelHistoricalElectrical(
                    Pic.getText().toString(),
                    MaintenanceDate.getText().toString(),
                    Remarks.getText().toString()

            ));
            Toast.makeText(AddHistoryPmElectrical.this, "Uploading Success", Toast.LENGTH_SHORT).show();
            Intent i = new Intent(AddHistoryPmElectrical.this, MyListElectrical.class);
            startActivity(i);
        } else {
            Toast.makeText(AddHistoryPmElectrical.this, "Insufficient Access Level", Toast.LENGTH_SHORT).show();
            finish();
        }
    }
