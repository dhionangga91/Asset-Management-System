...
public class UpdateElectrical extends AppCompatActivity implements View.OnClickListener {

    //Deklarasi Variable
    private EditText nameBaru, brandBaru, capacityBaru, locationBaru, maintenanceDateBaru ,voltageBaru, ampereBaru, StatusCek;
    ...
    private String cekCODE, cekName, cekBrand, cekCapacity, cekLocation, cekMaintenance, cekVoltage, cekAmpere;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_electrical);
        ...
        ampereBaru = findViewById(R.id.new_ampere);
        ...
        Btn_calendar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(UpdateElectrical.this, date, myCalendar
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cekAmpere = ampereBaru.getText().toString();
                cekLocation = locationBaru.getText().toString();
                cekMaintenance = maintenanceDateBaru.getText().toString();


                //Mengecek agar tidak ada data yang kosong, saat proses update
                if( isEmpty(cekCODE) ||isEmpty(cekName) || isEmpty(cekBrand) || isEmpty(cekCapacity) || isEmpty(cekAmpere) || isEmpty(cekVoltage) || isEmpty(cekLocation) || isEmpty(cekMaintenance)) {
                    Toast.makeText(UpdateElectrical.this, "Please Fill All Fields", Toast.LENGTH_SHORT).show();
                }
                else if(networkInfo == null){
                    Toast.makeText(getApplicationContext(),"Please check your internet connection", Toast.LENGTH_LONG).show();
                }
                else if (StatusCek.getText().toString().equals("Inactive")){
                    Toast.makeText(UpdateElectrical.this, "This Asset has been Deactivated", Toast.LENGTH_SHORT).show();
                }
                else {
                    /*
                    ...
                    */
                    ...
                    setElectrical.setVoltage(voltageBaru.getText().toString());
                    setElectrical.setAmpere(ampereBaru.getText().toString());
                    setElectrical.setLocation(locationBaru.getText().toString());
                    setElectrical.setMaintenanceDate(maintenanceDateBaru.getText().toString());
                    setElectrical.setUser(userBaru.getText().toString());
                    setElectrical.setModifiedDate(modifiedDateBaru.getText().toString());
                    setElectrical.setStatusAset(Status.getText().toString());
        ...
        database.child("Aset")
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(UpdateElectrical.this, "Successful uploaded", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                });
    }
    ...
    private void getImage() {
        ...
        AlertDialog.Builder dialog = new AlertDialog.Builder(UpdateElectrical.this)
