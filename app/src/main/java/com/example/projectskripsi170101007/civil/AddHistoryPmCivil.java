...
public class AddHistoryPmCivil extends AppCompatActivity {

    private TextView MaintenanceDate,Pic,Remarks,Name,Location,Status,CurrentUser;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_history_pm_civil);
        ...
        Submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ( isEmpty(getRemarks) || isEmpty(getPic) || isEmpty(getMaintenanceDate) || isEmpty(getLocation) || isEmpty(getName) ) {
                    //Jika Ada, maka akan menampilkan pesan singkan seperti berikut ini.
                    Toast.makeText(AddHistoryPmCivil.this, "Incomplete Data", Toast.LENGTH_SHORT).show();
                } else {
                   cekKoneksi();
    ...
    private void cekStatus() {
        if (Status.getText().toString().equals("Approved")){
            ...
            Toast.makeText(AddHistoryPmCivil.this,"Workorder not approved yet",Toast.LENGTH_SHORT).show();
        }
    }

    private void uploadData() {
        if( (CurrentUser.getText().toString().equals(AuthAdmin))  && mDatabase != null) {
            mDatabase.child("Aset").child("History").child("Civil").push().setValue(new ModelHistoricalCivil(
            ...
            Toast.makeText(AddHistoryPmCivil.this, "Uploading Success", Toast.LENGTH_SHORT).show();
            Intent i = new Intent(AddHistoryPmCivil.this, MyListWoCivil.class);
            startActivity(i);
        } else {
            Toast.makeText(AddHistoryPmCivil.this, "Insufficient Access Level", Toast.LENGTH_SHORT).show();
            finish();
        }
    }
