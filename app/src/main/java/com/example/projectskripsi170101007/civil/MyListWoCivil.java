...
import com.example.projectskripsi170101007.adapter.RecyclerViewAdapter8;
...
public class  MyListWoCivil extends AppCompatActivity implements RecyclerViewAdapter8.dataListener {
    //Deklarasi Variable untuk RecyclerView
    private RecyclerView recyclerView;
    private RecyclerView.Adapter adapter;
    private FirebaseRecyclerOptions<ModelWoCivil> options;
    ...
    private ArrayList<ModelWoCivil> dataWoCivil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_list_wo_civil);
        ...
        Home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MyListWoCivil.this, MainActivity.class);
        ...
        getSupportActionBar().setTitle("WorkOrder Civil");
    ...
    private void cekKoneksi() {
        ...
        if(networkInfo != null && networkInfo.isConnected()){
            ...
            options = new FirebaseRecyclerOptions.Builder<ModelWoCivil>()
                    //   Referensi Database yang akan digunakan beserta data Modelnya
                    .setQuery(mDatabase.child("Aset").child("Workorder").child("civil"), ModelWoCivil.class)
    ...
    private void GetDataReject() {
        ...
        auth = FirebaseAuth.getInstance();
        mDatabase.child("Aset").child("Workorder").child("civil").orderByChild("status").equalTo("Reject")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        dataWoCivil = new ArrayList<>();

                        for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                            //Mapping data pada DataSnapshot ke dalam objek civil
                            ModelWoCivil modelWoCivil = snapshot.getValue(ModelWoCivil.class);

                            //Mengambil Primary Key, digunakan untuk proses Update dan Delete
                            modelWoCivil.setKey(snapshot.getKey());
                            dataWoCivil.add(modelWoCivil);
                            ImageURL.setText(modelWoCivil.getPicture());
                        }

                        //Inisialisasi Adapter dan data Wo dalam bentuk Array
                        adapter = new RecyclerViewAdapter8(dataWoCivil, MyListWoCivil.this);
    ...
    private void GetDataApproved() {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference();
        auth = FirebaseAuth.getInstance();
        mDatabase.child("Aset").child("Workorder").child("civil").orderByChild("status").equalTo("Approved")
                .addValueEventListener(new ValueEventListener() {
    ...
    private void GetDataFinish() {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference();
        auth = FirebaseAuth.getInstance();
        mDatabase.child("Aset").child("Workorder").child("civil").orderByChild("status").equalTo("Finish")
                .addValueEventListener(new ValueEventListener() {
    ...
    private void GetDataWaitfor() {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference();
        auth = FirebaseAuth.getInstance();
        mDatabase.child("Aset").child("Workorder").child("civil").orderByChild("status").equalTo("In Queue")
                .addValueEventListener(new ValueEventListener() {
    ...
    private void GetDataOnProgress() {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference();
        auth = FirebaseAuth.getInstance();
        mDatabase.child("Aset").child("Workorder").child("civil").orderByChild("status").equalTo("On Progress")
                .addValueEventListener(new ValueEventListener() {
...
//                .orderByChild("status").equalTo("On Progress")
    ...
    @Override
    public void onDeleteData(ModelWoCivil data, int position) {
        /*
            ...
            mDatabase.child("Aset")
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            Toast.makeText(MyListWoCivil.this, "Succesfully deleted", Toast.LENGTH_SHORT).show();
                        }
                    });
        }else {
            Toast.makeText(MyListWoCivil.this, "Insufficient Access Level", Toast.LENGTH_SHORT).show();
        }
    }
