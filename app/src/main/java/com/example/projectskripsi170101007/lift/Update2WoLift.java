...
public class Update2WoLift extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update2_wo_lift);
        ...
        Submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if( isEmpty(cekRemarks) ) {
                    Toast.makeText(Update2WoLift.this, "Please Fill All Fields", Toast.LENGTH_SHORT).show();
                } else if (StatusCek.getText().toString().equals("In Queue")){
                    Toast.makeText(Update2WoLift.this, "This Workorder is not started yet", Toast.LENGTH_SHORT).show();
                }
                else if (StatusCek.getText().toString().equals("Finish")){
                    Toast.makeText(Update2WoLift.this, "This Workorder has already finish", Toast.LENGTH_SHORT).show();
                }
                else if (StatusCek.getText().toString().equals("Approved")){
                    Toast.makeText(Update2WoLift.this, "This Workorder has already approved", Toast.LENGTH_SHORT).show();
                }
                else if (StatusCek.getText().toString().equals("Reject")){
                    Toast.makeText(Update2WoLift.this, "This Workorder has already rejected", Toast.LENGTH_SHORT).show();
                }
                    ...
                    */
                    ...
                    ModelWoLift setLift = new ModelWoLift();
                    setLift.setWocode(Wocode.getText().toString());
                    setLift.setName(Name.getText().toString());
                    setLift.setLocation(Location.getText().toString());
                    setLift.setPic(Pic.getText().toString());
                    setLift.setMaintenanceDate(MaintenanceDate.getText().toString());
                    setLift.setRemarks(Remarks.getText().toString());
                    setLift.setStatus(Status.getText().toString());
                    setLift.setUserInput(UserInput.getText().toString());
                    setLift.setWoDate(WoDate.getText().toString());
                    setLift.setUserStart(UserStart.getText().toString());
                    setLift.setStartDate(StartDate.getText().toString());
                    setLift.setUserFinish(UserFinish.getText().toString());
                    setLift.setFinishDate(FinishDate.getText().toString());
                    setLift.setUserApproved(UserApproved.getText().toString());
                    setLift.setApprovedDate(ApprovedDate.getText().toString());
                    setLift.setUserReject(UserReject.getText().toString());
                    setLift.setRejectDate(RejectDate.getText().toString());
                    updateWoLift(setLift);
                    uploadImage();
                }
            }
        });
                ...
                if(task.isSuccessful()){
                    ...
                    mStorage.child(pathImage).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            mDatabase = FirebaseDatabase.getInstance().getReference();
                            mDatabase.child("Aset").child("Workorder").child("lift").child(getKey).child("picture").setValue(downloadURL);
                        }
                    });
                }
            }
    ...
    private void updateWoLift(ModelWoLift setLift) {
        ...
        mDatabase.child("Aset")
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(Update2WoLift.this, "Successfull Updated", Toast.LENGTH_SHORT).show();
                        showNotification();
                        finish();
                    }
                });
