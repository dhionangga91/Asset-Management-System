...
import com.example.projectskripsi170101007.adapter.RvaHistoryLift;
...
public class HistoryListPmLift extends AppCompatActivity {
    ...
    private FirebaseRecyclerOptions<ModelHistoricalPmLift> options;

    //Deklarasi Variable Database Reference dan ArrayList dengan Parameter Class Model kita.
    private DatabaseReference mDatabase;
    private ArrayList<ModelHistoricalPmLift> dataHistory;
    ...
    List<ModelHistoricalPmLift> historylist;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_history_list_pm_lift);
    ...
    private void cekKoneksi() {
        ...
        if(networkInfo != null && networkInfo.isConnected()){
            ...
            options = new FirebaseRecyclerOptions.Builder<ModelHistoricalPmLift>()
                    // Referensi Database yang akan digunakan beserta data Modelnya
                    .setQuery(mDatabase.child("Aset").child("History").child("Lift"), ModelHistoricalPmLift.class)
    ...
    private void GetData(){
        ...
        mDatabase.child("Aset").child("History").child("Lift").child(Name.getText().toString())
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                            ...
                            ModelHistoricalPmLift historicalPM = snapshot.getValue(ModelHistoricalPmLift.class);
                        ...
                        adapter = new RvaHistoryLift(dataHistory, HistoryListPmLift.this);
    ...
    private void fetchPaymentUsers() {
        mDatabase = FirebaseDatabase.getInstance().getReference().child("Aset").child("History").child("Lift").child(Name.getText().toString());
...
//creating an object and setting to displlay
                    ModelHistoricalPmLift pays = new ModelHistoricalPmLift();
    ...
    private void createHistoryReport(List<ModelHistoricalPmLift> historylist) throws DocumentException, FileNotFoundException{
        ...
        for (int i = 0; i < historylist.size(); i++) {
            ModelHistoricalPmLift pay = historylist.get(i);
