...
public class ModelElectrical {
    ...
    public static ModelElectrical get(int position) {
        return null;
    }
    ...
    public ModelElectrical(){
    }

    //Konstruktor dengan beberapa parameter, untuk mendapatkan Input Data dari User
    public ModelElectrical(String code, String name, String brand, String capacity, String location, String maintenanceDate , String modifiedDate, String picture, String user, String voltage, String ampere, String statusAset) {
        this.code = code;
        this.name = name;
        this.brand = brand;
        this.capacity = capacity;
