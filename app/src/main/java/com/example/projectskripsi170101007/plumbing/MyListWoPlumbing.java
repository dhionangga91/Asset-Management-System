...
import com.example.projectskripsi170101007.adapter.RecyclerViewAdapter6;
...
public class MyListWoPlumbing extends AppCompatActivity implements RecyclerViewAdapter6.dataListener {
    //Deklarasi Variable untuk RecyclerView
    private RecyclerView recyclerView;
    private RecyclerView.Adapter adapter;
    private FirebaseRecyclerOptions<ModelWoPlumbing> options;
    ...
    private ArrayList<ModelWoPlumbing> dataWoPlumbing;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_list_wo_plumbing);
        ...
        Home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MyListWoPlumbing.this, MainActivity.class);
        ...
        getSupportActionBar().setTitle("WorkOrder Plumbing");
    ...
    private void cekKoneksi() {
        ...
        if(networkInfo != null && networkInfo.isConnected()){
            ...
            options = new FirebaseRecyclerOptions.Builder<ModelWoPlumbing>()
                    //   Referensi Database yang akan digunakan beserta data Modelnya
                    .setQuery(mDatabase.child("Aset").child("Workorder").child("plumbing"), ModelWoPlumbing.class)
    ...
    private void GetDataReject() {
        ...
        auth = FirebaseAuth.getInstance();
        mDatabase.child("Aset").child("Workorder").child("plumbing").orderByChild("status").equalTo("Reject")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        dataWoPlumbing = new ArrayList<>();

                        for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                            //Mapping data pada DataSnapshot ke dalam objek plumbing
                            ModelWoPlumbing modelWoPlumbing = snapshot.getValue(ModelWoPlumbing.class);

                            //Mengambil Primary Key, digunakan untuk proses Update dan Delete
                            modelWoPlumbing.setKey(snapshot.getKey());
                            dataWoPlumbing.add(modelWoPlumbing);
                            ImageURL.setText(modelWoPlumbing.getPicture());
                        }

                        //Inisialisasi Adapter dan data Wo dalam bentuk Array
                        adapter = new RecyclerViewAdapter6(dataWoPlumbing, MyListWoPlumbing.this);
    ...
    private void GetDataApproved() {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference();
        auth = FirebaseAuth.getInstance();
        mDatabase.child("Aset").child("Workorder").child("plumbing").orderByChild("status").equalTo("Approved")
                .addValueEventListener(new ValueEventListener() {
    ...
    private void GetDataFinish() {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference();
        auth = FirebaseAuth.getInstance();
        mDatabase.child("Aset").child("Workorder").child("plumbing").orderByChild("status").equalTo("Finish")
                .addValueEventListener(new ValueEventListener() {
    ...
    private void GetDataWaitfor() {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference();
        auth = FirebaseAuth.getInstance();
        mDatabase.child("Aset").child("Workorder").child("plumbing").orderByChild("status").equalTo("In Queue")
                .addValueEventListener(new ValueEventListener() {
    ...
    private void GetDataOnProgress() {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference();
        auth = FirebaseAuth.getInstance();
        mDatabase.child("Aset").child("Workorder").child("plumbing").orderByChild("status").equalTo("On Progress")
                .addValueEventListener(new ValueEventListener() {
...
//                .orderByChild("status").equalTo("On Progress")
    ...
    @Override
    public void onDeleteData(ModelWoPlumbing data, int position) {
        /*
            ...
            mDatabase.child("Aset")
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            Toast.makeText(MyListWoPlumbing.this, "Succesfully deleted", Toast.LENGTH_SHORT).show();
                        }
                    });
        }else {
            Toast.makeText(MyListWoPlumbing.this, "Insufficient Access Level", Toast.LENGTH_SHORT).show();
        }
    }
