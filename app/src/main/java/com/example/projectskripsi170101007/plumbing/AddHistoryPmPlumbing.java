...
public class AddHistoryPmPlumbing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_history_pm_plumbing);
        ...
        Submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ( isEmpty(getRemarks) || isEmpty(getPic) || isEmpty(getMaintenanceDate) ) {
                    ...
                    Toast.makeText(AddHistoryPmPlumbing.this, "Incomplete Data", Toast.LENGTH_SHORT).show();
                } else {
                    cekKoneksi();
    ...
    private void cekStatus() {
        if (Status.getText().toString().equals("Approved")){
            ...
            Toast.makeText(AddHistoryPmPlumbing.this,"Workorder not approved yet",Toast.LENGTH_SHORT).show();
        }
    }

    private void uploadData() {
        if( (CurrentUser.getText().toString().equals(AuthAdmin))  && mDatabase != null) {
            mDatabase.child("Aset").child("History").child("Plumbing").child(Name.getText().toString()).push().setValue(new ModelHistoricalPmPlumbing(
                    Pic.getText().toString(),
                    MaintenanceDate.getText().toString(),
                    Remarks.getText().toString()

            ));
            Toast.makeText(AddHistoryPmPlumbing.this, "Uploading Success", Toast.LENGTH_SHORT).show();
            Intent i = new Intent(AddHistoryPmPlumbing.this, MyListPlumbing.class);
            startActivity(i);
        } else {
            Toast.makeText(AddHistoryPmPlumbing.this, "Insufficient Access Level", Toast.LENGTH_SHORT).show();
            finish();
        }
    }
