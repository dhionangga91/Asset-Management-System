...
import com.example.projectskripsi170101007.adapter.RvaHistoryPlumbing;
import com.example.projectskripsi170101007.model.ModelHistoricalPmPlumbing;
...
public class HistoryListPmPlumbing extends AppCompatActivity {
    ...
    private FirebaseRecyclerOptions<ModelHistoricalPmPlumbing> options;

    //Deklarasi Variable Database Reference dan ArrayList dengan Parameter Class Model kita.
    private DatabaseReference mDatabase;
    private ArrayList<ModelHistoricalPmPlumbing> dataHistory;
    ...
    List<ModelHistoricalPmPlumbing> historylist;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_history_list_pm_plumbing);

        Name = findViewById(R.id.name);
        Location = findViewById(R.id.location);
        Export = findViewById(R.id.eksport);
        recyclerView = findViewById(R.id.datalist);
        getSupportActionBar().setTitle("History PM");
    ...
    private void cekKoneksi() {
        ...
        if(networkInfo != null && networkInfo.isConnected()){
            ...
            options = new FirebaseRecyclerOptions.Builder<ModelHistoricalPmPlumbing>()
                    // Referensi Database yang akan digunakan beserta data Modelnya
                    .setQuery(mDatabase.child("Aset").child("History").child("Plumbing"), ModelHistoricalPmPlumbing.class)
            ...
            pFile = new File(historyfile, Name.getText().toString().trim()+"_"+ new SimpleDateFormat("yyyyMMdd_HHmmss",
    ...
    private void GetData(){
        ...
        mDatabase.child("Aset").child("History").child("Plumbing").child(Name.getText().toString())
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                            ...
                            ModelHistoricalPmPlumbing historicalPM = snapshot.getValue(ModelHistoricalPmPlumbing.class);
                        ...
                        adapter = new RvaHistoryPlumbing(dataHistory, HistoryListPmPlumbing.this);
    ...
    private void fetchPaymentUsers() {
        mDatabase = FirebaseDatabase.getInstance().getReference().child("Aset").child("History").child("Plumbing").child(Name.getText().toString());
...
//creating an object and setting to displlay
                    ModelHistoricalPmPlumbing pays = new ModelHistoricalPmPlumbing();
    ...
    private void createHistoryReport(List<ModelHistoricalPmPlumbing> historylist) throws DocumentException, FileNotFoundException{
        ...
        for (int i = 0; i < historylist.size(); i++) {
            ModelHistoricalPmPlumbing pay = historylist.get(i);
        ...
        document.add(new Paragraph("Asset Maintenance System Report\n", g));
        document.add(new Paragraph("Asset Name : "+Name.getText().toString()+"\n", g));
        document.add(new Paragraph("Location : "+Location.getText().toString()+" Floor\n\n", g));
        document.add(table);
    ...
    private void savePdf() {
        ...
        //pdf file name
        String mFileName =Name.getText().toString().trim()+"_"+ new SimpleDateFormat("yyyyMMdd_HHmmss",
