...
public class Update2WoPlumbing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update2_wo_plumbing);
        ...
        Submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if( isEmpty(cekRemarks) ) {
                    Toast.makeText(Update2WoPlumbing.this, "Please Fill All Fields", Toast.LENGTH_SHORT).show();
                } else if (StatusCek.getText().toString().equals("In Queue")){
                    Toast.makeText(Update2WoPlumbing.this, "This Workorder is not started yet", Toast.LENGTH_SHORT).show();
                }
                else if (StatusCek.getText().toString().equals("Finish")){
                    Toast.makeText(Update2WoPlumbing.this, "This Workorder has already finish", Toast.LENGTH_SHORT).show();
                }
                else if (StatusCek.getText().toString().equals("Approved")){
                    Toast.makeText(Update2WoPlumbing.this, "This Workorder has already approved", Toast.LENGTH_SHORT).show();
                }
                else if (StatusCek.getText().toString().equals("Reject")){
                    Toast.makeText(Update2WoPlumbing.this, "This Workorder has already rejected", Toast.LENGTH_SHORT).show();
                }
        ...
        mDatabase.child("Aset")
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(Update2WoPlumbing.this, "Successfull Updated", Toast.LENGTH_SHORT).show();
                        showNotification();
                        finish();
                    }
                });
