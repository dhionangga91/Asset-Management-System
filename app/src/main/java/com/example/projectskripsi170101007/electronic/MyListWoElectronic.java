...
import com.example.projectskripsi170101007.adapter.RecyclerViewAdapter10;
...
public class MyListWoElectronic extends AppCompatActivity implements RecyclerViewAdapter10.dataListener {
    //Deklarasi Variable untuk RecyclerView
    private RecyclerView recyclerView;
    private RecyclerView.Adapter adapter;
    private FirebaseRecyclerOptions<ModelWoElectronic> options;
    ...
    private ArrayList<ModelWoElectronic> dataWoElectronic;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_list_wo_electronic);
        ...
        Home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MyListWoElectronic.this, MainActivity.class);
        ...
        getSupportActionBar().setTitle("WorkOrder Electronic");
    ...
    private void cekKoneksi() {
        ...
        if(networkInfo != null && networkInfo.isConnected()){
            ...
            options = new FirebaseRecyclerOptions.Builder<ModelWoElectronic>()
                    //   Referensi Database yang akan digunakan beserta data Modelnya
                    .setQuery(mDatabase.child("Aset").child("Workorder").child("electronic"), ModelWoElectronic.class)
    ...
    private void GetDataReject() {
        ...
        auth = FirebaseAuth.getInstance();
        mDatabase.child("Aset").child("Workorder").child("electronic").orderByChild("status").equalTo("Reject")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        dataWoElectronic = new ArrayList<>();

                        for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                            //Mapping data pada DataSnapshot ke dalam objek electronic
                            ModelWoElectronic modelWoElectronic = snapshot.getValue(ModelWoElectronic.class);

                            //Mengambil Primary Key, digunakan untuk proses Update dan Delete
                            modelWoElectronic.setKey(snapshot.getKey());
                            dataWoElectronic.add(modelWoElectronic);
                            ImageURL.setText(modelWoElectronic.getPicture());
                        }

                        //Inisialisasi Adapter dan data Wo dalam bentuk Array
                        adapter = new RecyclerViewAdapter10(dataWoElectronic, MyListWoElectronic.this);
    ...
    private void GetDataApproved() {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference();
        auth = FirebaseAuth.getInstance();
        mDatabase.child("Aset").child("Workorder").child("electronic").orderByChild("status").equalTo("Approved")
                .addValueEventListener(new ValueEventListener() {
    ...
    private void GetDataFinish() {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference();
        auth = FirebaseAuth.getInstance();
        mDatabase.child("Aset").child("Workorder").child("electronic").orderByChild("status").equalTo("Finish")
                .addValueEventListener(new ValueEventListener() {
    ...
    private void GetDataWaitfor() {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference();
        auth = FirebaseAuth.getInstance();
        mDatabase.child("Aset").child("Workorder").child("electronic").orderByChild("status").equalTo("In Queue")
                .addValueEventListener(new ValueEventListener() {
    ...
    private void GetDataOnProgress() {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference();
        auth = FirebaseAuth.getInstance();
        mDatabase.child("Aset").child("Workorder").child("electronic").orderByChild("status").equalTo("On Progress")
                .addValueEventListener(new ValueEventListener() {
...
//                .orderByChild("status").equalTo("On Progress")
    ...
    @Override
    public void onDeleteData(ModelWoElectronic data, int position) {
        /*
            ...
            mDatabase.child("Aset")
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            Toast.makeText(MyListWoElectronic.this, "Succesfully deleted", Toast.LENGTH_SHORT).show();
                        }
                    });
        }else {
            Toast.makeText(MyListWoElectronic.this, "Insufficient Access Level", Toast.LENGTH_SHORT).show();
        }
    }
