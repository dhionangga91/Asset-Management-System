...
import com.example.projectskripsi170101007.adapter.RvaHistoryElectronic;
...
public class HistoryListPmElectronic extends AppCompatActivity {
    ...
    private FirebaseRecyclerOptions<ModelHistoricalPmElectronic> options;

    //Deklarasi Variable Database Reference dan ArrayList dengan Parameter Class Model kita.
    private DatabaseReference mDatabase;
    private ArrayList<ModelHistoricalPmElectronic> dataHistory;
    ...
    List<ModelHistoricalPmElectronic> historylist;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_history_list_pm_electronic);
    ...
    private void cekKoneksi() {
        ...
        if(networkInfo != null && networkInfo.isConnected()){
            ...
            options = new FirebaseRecyclerOptions.Builder<ModelHistoricalPmElectronic>()
                    // Referensi Database yang akan digunakan beserta data Modelnya
                    .setQuery(mDatabase.child("Aset").child("History").child("Electronic"), ModelHistoricalPmElectronic.class)
    ...
    private void GetData(){
        ...
        mDatabase.child("Aset").child("History").child("Electronic").child(Name.getText().toString())
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                            ...
                            ModelHistoricalPmElectronic historicalPM = snapshot.getValue(ModelHistoricalPmElectronic.class);
                        ...
                        adapter = new RvaHistoryElectronic(dataHistory, HistoryListPmElectronic.this);
    ...
    private void fetchPaymentUsers() {
        mDatabase = FirebaseDatabase.getInstance().getReference().child("Aset").child("History").child("Electronic").child(Name.getText().toString());
...
//creating an object and setting to displlay
                    ModelHistoricalPmElectronic pays = new ModelHistoricalPmElectronic();
    ...
    private void createHistoryReport(List<ModelHistoricalPmElectronic> historylist) throws DocumentException, FileNotFoundException{
        ...
        for (int i = 0; i < historylist.size(); i++) {
            ModelHistoricalPmElectronic pay = historylist.get(i);
