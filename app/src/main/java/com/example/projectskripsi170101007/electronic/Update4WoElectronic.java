...
public class Update4WoElectronic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update4_wo_electronic);
        ...
        Submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if( isEmpty(cekRemarks) ) {
                    Toast.makeText(Update4WoElectronic.this, "Please Fill All Fields", Toast.LENGTH_SHORT).show();
                }
                else if (StatusCek.getText().toString().equals("In Queue")){
                    Toast.makeText(Update4WoElectronic.this, "This Workorder is not over yet", Toast.LENGTH_SHORT).show();
                }
                else if (StatusCek.getText().toString().equals("On Progress")){
                    Toast.makeText(Update4WoElectronic.this, "This Workorder is not over yet", Toast.LENGTH_SHORT).show();
                }
                else if (StatusCek.getText().toString().equals("Approved")){
                    Toast.makeText(Update4WoElectronic.this, "This Workorder already approved", Toast.LENGTH_SHORT).show();
                }
                else if (StatusCek.getText().toString().equals("Reject")){
                    Toast.makeText(Update4WoElectronic.this, "This Workorder has already rejected", Toast.LENGTH_SHORT).show();
                }
    ...
    private void cekAdmin() {
        if ((CurrentUser.getText().toString().equals(AuthAdmin))){
            ...
            Toast.makeText(Update4WoElectronic.this, "Insufficient Access Level", Toast.LENGTH_SHORT).show();
        }
    }
        ...
        mDatabase.child("Aset")
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(Update4WoElectronic.this, "Successfull Updated", Toast.LENGTH_SHORT).show();
                        showNotification();
                        finish();
                    }
                });
