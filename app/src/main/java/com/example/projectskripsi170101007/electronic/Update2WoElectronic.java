...
public class Update2WoElectronic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update2_wo_electronic);
        ...
        Submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if( isEmpty(cekRemarks) ) {
                    Toast.makeText(Update2WoElectronic.this, "Please Fill All Fields", Toast.LENGTH_SHORT).show();
                } else if (StatusCek.getText().toString().equals("In Queue")){
                    Toast.makeText(Update2WoElectronic.this, "This Workorder is not started yet", Toast.LENGTH_SHORT).show();
                }
                else if (StatusCek.getText().toString().equals("Finish")){
                    Toast.makeText(Update2WoElectronic.this, "This Workorder has already finish", Toast.LENGTH_SHORT).show();
                }
                else if (StatusCek.getText().toString().equals("Approved")){
                    Toast.makeText(Update2WoElectronic.this, "This Workorder has already approved", Toast.LENGTH_SHORT).show();
                }
                else if (StatusCek.getText().toString().equals("Reject")){
                    Toast.makeText(Update2WoElectronic.this, "This Workorder has already rejected", Toast.LENGTH_SHORT).show();
                }
                    ...
                    */
                    ...
                    ModelWoElectronic setElectronic = new ModelWoElectronic();
                    setElectronic.setWocode(Wocode.getText().toString());
                    setElectronic.setName(Name.getText().toString());
                    setElectronic.setLocation(Location.getText().toString());
                    setElectronic.setPic(Pic.getText().toString());
                    setElectronic.setMaintenanceDate(MaintenanceDate.getText().toString());
                    setElectronic.setRemarks(Remarks.getText().toString());
                    setElectronic.setStatus(Status.getText().toString());
                    setElectronic.setUserInput(UserInput.getText().toString());
                    setElectronic.setWoDate(WoDate.getText().toString());
                    setElectronic.setUserStart(UserStart.getText().toString());
                    setElectronic.setStartDate(StartDate.getText().toString());
                    setElectronic.setUserFinish(UserFinish.getText().toString());
                    setElectronic.setFinishDate(FinishDate.getText().toString());
                    setElectronic.setUserApproved(UserApproved.getText().toString());
                    setElectronic.setApprovedDate(ApprovedDate.getText().toString());
                    setElectronic.setUserReject(UserReject.getText().toString());
                    setElectronic.setRejectDate(RejectDate.getText().toString());
                    updateWoElectronic(setElectronic);
                    uploadImage();
                }
            }
        });
                ...
                if(task.isSuccessful()){
                    ...
                    mStorage.child(pathImage).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            mDatabase = FirebaseDatabase.getInstance().getReference();
                            mDatabase.child("Aset").child("Workorder").child("electronic").child(getKey).child("picture").setValue(downloadURL);
                        }
                    });
                }
            }
    ...
    private void updateWoElectronic(ModelWoElectronic setElectronic) {
        ...
        mDatabase.child("Aset")
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(Update2WoElectronic.this, "Successfull Updated", Toast.LENGTH_SHORT).show();
                        showNotification();
                        finish();
                    }
                });
    ...
    private void getData() {
        mDatabase.child("Aset").child("Workorder").child("electronic");
